              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div data-aos="zoom-in-left" className="relative flex justify-center lg:justify-end">
                  ...
                  <div className="relative w-full max-w-xl">
                    ...
                    <div data-aos="zoom-out" className="absolute bottom-10 left-4 md:bottom-28 md:-left-20 bg-slate-900/90 backdrop-blur-xl border border-cyan-500/30 rounded-2xl p-3 md:p-4 shadow-xl shadow-cyan-500/20">                      <div className="flex items-center gap-3">
